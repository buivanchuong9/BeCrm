...
export function toWorkflowInstanceResponse(
  ...
  return {
    ...
    integrityHash: instance.integrityHash,
...
export function toWorkflowTaskResponse(task: WorkflowTask): WorkflowTaskResponseDto {
  return {
    ...
    abnormalResultFlaggedAt: task.abnormalResultFlaggedAt?.toISOString() ?? null,
    abnormalResultEscalatedTo: task.abnormalResultEscalatedTo,
